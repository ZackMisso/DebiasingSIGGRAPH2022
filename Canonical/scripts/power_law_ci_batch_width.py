...
for alpha_ind in range(0, 71):
    ...
    graph_title = "CI width between 45th, 55th percentiles : alpha = " + \
        str(alpha)
    xaxis_title = "Samples"
    yaxis_title = "Width"
    ...
    plt.xlim(2048, 131072 * 16)

    path_to_results = "../results/"+path+"/alpha_" + \
        str(alpha_ind+20) + "/ci_width_45_55.png"
    ...
    plt.plot(samples, widths, "r-", zorder=3.0)
