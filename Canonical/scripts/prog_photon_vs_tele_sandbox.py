...
# paths_to_data.append("../corneria_build/equal_cost_safen_noinst.txt")
# paths_to_data.append("../corneria_build/equal_cost_safen.txt")

folders = ["r_1_0000_low", "r_0_5000_low",
           "r_0_2500_low", "r_0_1250_low", "r_0_0625_low", "r_1_0000", "r_0_5000",
           "r_0_2500", "r_0_1250", "r_0_0625"]
radii = ["1.0", "0.5", "0.25", "0.125", "0.0625",
         "1.0", "0.5", "0.25", "0.125", "0.0625"]

for k in range(0, len(folders)):
    paths_to_data = []
    paths_to_data.append(
        "../results/photon_deb_vs_ppm/"+folders[k]+"/equal_cost_deb.txt")
    paths_to_data.append(
        "../results/photon_deb_vs_ppm/"+folders[k]+"/equal_cost_ppm.txt")
    path_to_results = "../results/photon_deb_vs_ppm/" + \
        folders[k]+"/deb_vs_ppm.png"
    names = ["debiased", "ppm"]

    graph_title = "Debiased Vs. PPM with base_radius = " + radii[k]
