...
for test in tests:
    ...
    paths_to_data = []
    paths_to_data.append("../results/power_law_conv/" +
                         test+"/temp_sample_errs_0.txt")
    path_to_results = "../results/power_law_conv/"+test+"/sample_errs_slopes.png"
    names = []
    names.append("blanchet")
    ...
    for i in range(len(ys)):
        plt.plot(slopes_x, slopes, "-", label=names[i])
