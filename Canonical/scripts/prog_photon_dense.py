...
paths_to_data.append("../corneria_build/origin_conv_fixed_full.txt")
path_to_results = "../corneria_build/origin_prog_fixed_full.png"
names = []

graph_title = "Progressive density estimation"
xaxis_title = "progressive iteration"
yaxis_title = "MSE"
