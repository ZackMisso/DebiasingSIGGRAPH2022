...
struct BlanchetPhotonSafeN : Technique<Float>
{
    struct Photon
    {
    ...
    BlanchetPhotonSafeN(Float r = 0.65, int base_photons = 1000)
    ...
    virtual std::string getName() const { return "blanchet_secondary_safe_n"; }
