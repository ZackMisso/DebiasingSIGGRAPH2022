...
struct BlanchetSecondaryPhoton : Technique<Float>
{
    struct Photon
    {
    ...
    BlanchetSecondaryPhoton(Float r = 0.65, int base_photons = 1000, int samples = 128)
    ...
    virtual std::string getName() const { return "blanchet_highdense_photon"; }
