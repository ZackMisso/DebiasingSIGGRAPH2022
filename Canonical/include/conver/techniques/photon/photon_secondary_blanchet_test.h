...
struct BlanchetSecondaryPhotonTest : Technique<Float>
{
    struct Photon
    {
    ...
    BlanchetSecondaryPhotonTest(Float r = 0.65, int base_photons = 1000, int samples = 128)
    ...
    virtual std::string getName() const { return "blanchet_" + std::to_string(blanchet_r); }
