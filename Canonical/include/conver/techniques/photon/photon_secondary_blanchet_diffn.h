...
struct BlanchetSecondaryPhotonDiffN : Technique<Float>
{
    struct Photon
    {
    ...
    BlanchetSecondaryPhotonDiffN(Float r = 0.65, int base_photons = 1000, int samples = 128)
    ...
    virtual Float eval_problem(const Problem<Float> *problem, int samples, int &cost, pcg32 &rng) const
    {
        ...
        int total_photons = base_photons * pow(2, n);
    ...
    virtual std::string getName() const { return "blanchet_highdense_photon_n"; }
